...
<head>
    ...
    <title> Romy Gonzalez Statistics</title>
</head>
...
<tr>
    <td><img src="/baseballsites/images/redsox/romy.png" alt="Romy Gonzalez"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM redsox WHERE playerID = 'gonzalezR'";
