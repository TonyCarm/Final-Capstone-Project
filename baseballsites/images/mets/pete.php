...
<head>
    ...
    <title>Pete Alonso Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Pete Alonso</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/pete.png" alt="Pete Alonso"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Pete Alonso'";
