...
<head>
    ...
    <title>Kodai Senga Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Kodai Senga</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/kodai.png" alt="Kodai Senga"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM pitchers WHERE playerID = 'Kodai Senga'";
