...
<head>
    ...
    <title>Brett Baty Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Brett Baty</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/brett.png" alt="Brett Baty"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Brett Baty'";
