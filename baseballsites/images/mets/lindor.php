...
<head>
    ...
    <title>Francisco Lindor Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Francisco Lindor</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/lindor.png" alt="Francisco Lindor"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Francisco Lindor'";
