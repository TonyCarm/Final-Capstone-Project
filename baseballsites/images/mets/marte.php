...
<head>
    ...
    <title>Starling Marte Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Starling Marte</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/marte.png" alt="Starling Marte"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Starling Marte'";
