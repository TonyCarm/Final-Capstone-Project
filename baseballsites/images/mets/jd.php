...
<head>
    ...
    <title>J.D. Martinez Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>J.D. Martinez</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/" alt="J.D. Martinez"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'J.D. Martinez'";
