...
<head>
    ...
    <title>Brandon Nimmo Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Brandon Nimmo</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/nimmo.png" alt="Brandon Nimmo"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Brandon Nimmo'";
