...
<head>
    ...
    <title>Harrison Bader Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Harrison Bader</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/bader.png" alt="Harrison Bader"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Harrison Bader'";
