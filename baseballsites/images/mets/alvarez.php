...
<head>
    ...
    <title>Francisco Alvarez Statistics</title>
</head>

<body class="mets">
<table >
    <th colspan="2"><h1>Francisco Alvarez</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/mets/francisco.png" alt="Francisco Alvarez"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM mets WHERE playerID = 'Francisco Alvarez'";
