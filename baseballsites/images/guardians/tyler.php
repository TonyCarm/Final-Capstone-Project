...
<head>
    ...
    <title>Tyler Freeman Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Tyler Freeman</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/tyler.png" alt="Tyler Freeman"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Tyler Freeman'";
