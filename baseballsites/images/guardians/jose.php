...
<head>
    ...
    <title>Jose Ramirez Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Jose Ramirez</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/jose.png" alt="Jose Ramirez"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Jose Ramirez'";
