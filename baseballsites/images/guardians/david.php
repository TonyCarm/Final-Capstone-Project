...
<head>
    ...
    <title>David Fry Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>David Fry</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/david.png" alt="David Fry"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'David Fry'";
