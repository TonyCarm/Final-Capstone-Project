...
<head>
    ...
    <title>Brayan Rocchio Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Brayan Rocchio</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/brayan.png" alt="Brayan Rocchio"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Brayan Rocchio'";
