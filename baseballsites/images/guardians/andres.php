...
<head>
    ...
    <title>Andres Gimenez Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Andres Gimenez</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/andres.png" alt="Andres Gimenez"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Andres Gimenez'";
