...
<head>
    ...
    <title>Josh Naylor Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Josh Naylor</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/josh.png" alt="Josh Naylor"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Josh Naylor'";
