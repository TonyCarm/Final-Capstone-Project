...
<head>
    ...
    <title>Ramon Laureano Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Ramon Laureano</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/ramon.png" alt="Ramon Laureano"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Ramon Laureano'";
