...
<head>
    ...
    <title>Austin Hedges Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Austin Hedges</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/austin.png" alt="Austin Hedges"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Austin Hedges'";
