...
<head>
    ...
    <title>Steven Kwan Statistics</title>
</head>

<body class="guardians">
<table >
    <th colspan="2"><h1>Steven Kwan</h1></th>
    
<tr>
    <td><img src="/baseballsites/images/guardians/steven.png" alt="Steven Kwan"></td>
...
<table class="table" border="p">
    ...
    <tr>
        ...
        $sql = "SELECT * FROM guardians WHERE playerID = 'Steven Kwan'";
